...
public class Driver {
    ...
    // We create a PRIVATE CONSTRUCTOR to remove access to this object.
    ...
    public static void closeDriver() {
        ...
        if (driver != null) {
            ...
            /*
            The below line will terminate the currently existing driver completely. it will not exist going forward
             */
            driver.quit();

            /*
            Then we assign the value back to "null" so that my "singleton" create  a newer one if needed.
             */
            driver = null;
